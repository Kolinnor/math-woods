...
export function milestoneTypeLabel(type: HistoryMilestoneType, locale: "en" | "fr") {
  const labels = {
    en: { PERIOD: "Historical period", EVENT: "Event", DISCOVERY: "Discovery", PUBLICATION: "Publication", NOTATION: "Notation", INSTITUTION: "Institution", BIOGRAPHICAL: "Biography", OTHER: "Milestone" },
    fr: { PERIOD: "Période historique", EVENT: "Événement", DISCOVERY: "Découverte", PUBLICATION: "Publication", NOTATION: "Notation", INSTITUTION: "Institution", BIOGRAPHICAL: "Biographie", OTHER: "Repère" }
  } as const;
  return labels[locale][type];
}
