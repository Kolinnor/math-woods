...
// Underscores no longer produce italic/bold like standard markdown: any run
// of one or more underscores (`_text_`, `__text__`, ...) renders as
// underline instead, as long as it isn't math (already protected before this
// stage) or a word-internal underscore (e.g. `a_a_a`, `variable_name`).
// `*text*` / `**text**` keep their normal italic / bold meaning.
