export const en = {
  ...
  markdownEditor: {
    ...
    localDraftConflict: "The page has changed. Your draft is preserved in this browser; the latest site version is shown. Restore your draft to resume your corrections.",
    discardLocalDraft: "Discard local draft",
    discardDraft: "Discard draft",
    addLink: "Add link",
    linkTypeAriaLabel: "Link type",
    linkTypeAll: "All types",
    linkTypeMathematician: "Mathematician",
    linkTypeHistory: "Historical milestone",
    linkTypeReference: "Reference",
    linkSearch: "Search for a page",
    linkSearchPlaceholder: "Title, name or keyword",
    linkSearchHelp: "Choose a destination from the results. Your selected text is preserved. Concept links use [[target|visible text]]: keep the target when translating and translate only the visible text.",
    linkSearchMinimum: "Enter at least two characters.",
    linkSearching: "Searching…",
    linkSearchError: "Search failed. Change your search to try again.",
  ...
  contentEditor: {
    ...
    conceptProposalConflict: "This concept changed while you were editing it. Your proposal was not submitted. The latest version is shown; if your browser saved a local draft, restore it in the editor below and compare both versions before submitting again.",
