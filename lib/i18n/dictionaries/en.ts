export const en = {
  ...
  conceptDetail: {
    ...
    coreContentReady: "The core explanation is present",
    examplesPresent: "At least one meaningful example is present",
    linkedExercisesProgress: (count: number, target: number) => `${count}/${target} linked exercises`,
    reviewChecklistGuidance: "This checklist is guidance for reviewers, not an automatic gate.",
