...
export const fr = {
  ...
  markdownEditor: {
    ...
    textShownHelp: "Texte qui apparaîtra sur la page.",
    textShownPlaceholder: "Texte dans l'article",
    linksTo: "Pointe vers",
    linksToHelp: "Page qui s'ouvrira quand on cliquera sur le lien.",
    ...
    newConceptLink: "Nouveau lien de concept : « {target} »",
