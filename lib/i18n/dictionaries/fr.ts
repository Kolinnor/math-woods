...
export const fr = {
  ...
  conceptDetail: {
    ...
    reviewChecklistTitle: "Checklist de relecture",
    coreContentReady: "L'explication centrale est présente",
    examplesPresent: "Au moins un exemple pertinent est présent",
    linkedExercisesProgress: (count: number, target: number) => `${count}/${target} exercices liés`,
    reviewChecklistGuidance: "Cette checklist guide la relecture sans bloquer automatiquement la validation.",
