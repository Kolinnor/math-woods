...
export const fr = {
  ...
  home: {
    ...
    domainLabels: {
      ...
      "several-variable-functions": "Fonction de plusieurs variables",
      "differential-equations": "Équation différentielle",
      "probability-statistics": "Probabilité et statistique",
      combinatorics: "Combinatoire",
      "graphs-discrete-math": "Mathématiques discrètes",
      computation: "Calculs",
      ...
      misc: "Autre",
      enigma: "Énigme",
      "logic-mathematical-logic": "Logique mathématique",
      "logic-model-theory": "Théorie des modèles",
      "logic-set-theory": "Théorie des ensembles",
      "algebraic-topology-fundamental-group": "Groupe fondamental",
      "algebraic-topology-homology-cohomology": "Homologie/Cohomologie",
      "algebra-group-actions": "Action de groupe",
      "algebra-fields": "Corps",
      "algebra-galois-theory": "Théorie de Galois",
      "algebra-groups": "Groupe",
      "algebra-modules": "Module",
      "algebra-rings": "Anneau",
      "linear-algebra-euclidean-spaces": "Espace vectoriel euclidien",
      "linear-algebra-hilbert-spaces": "Espace de Hilbert et préhilbertien",
      "linear-algebra-lie-algebras": "Algèbre de Lie",
      "linear-algebra-endomorphism-reduction": "Réduction d'endomorphisme",
      "linear-algebra-polynomial": "Polynôme",
      "linear-algebra-representations-characters": "Représentation et caractère",
      "geometry-non-euclidean-geometry": "Géométrie non euclidienne",
      "differential-geometry-de-rham-cohomology": "Cohomologie de De Rham",
      "complex-analysis-holomorphism": "Holomorphie",
      "topology-compact-sets": "Compact",
      "topology-connectedness": "Connexité",
      "topology-metric-spaces": "Espace métrique",
      "topology-normed-vector-spaces": "Espace vectoriel normé",
      "topology-riemann-surfaces": "Surface de Riemann",
      "real-analysis-continuity": "Continuité et continuité uniforme",
      "real-analysis-differentiation": "Dérivation",
      "real-analysis-fourier-series": "Série de Fourier",
      "real-analysis-power-series": "Série entière",
      "real-analysis-real-functions": "Fonction réelle",
      "real-analysis-riemann-integration": "Intégration de Riemann",
      "real-analysis-sequences-series": "Suite et série",
      "real-analysis-sequences-series-functions": "Suite et série de fonction",
      "multivariable-analysis-differentiation": "Différentielle",
      "multivariable-analysis-distributions": "Distribution",
      "multivariable-analysis-fourier-integration": "Transformée de Fourier",
      ...
      "differential-equations-ordinary": "Équation différentielle ordinaire",
      "differential-equations-partial": "Équation aux dérivées partielles",
      "probability-finite-spaces": "Probabilité sur un univers fini",
      "probability-game-theory": "Théorie des jeux",
      "probability-random-variables": "Variable aléatoire",
      "probability-statistical-methods": "Statistique",
      "probability-stochastic-processes": "Processus stochastique",
      "computation-asymptotics": "Calcul asymptotique",
      "computation-equation-solving": "Résolution d'équation",
      "computation-inequalities": "Inégalité",
      "discrete-mathematics-discrete-analysis": "Analyse discrète",
      ...
      "other-real-world-problem": "Problème de la vie réelle",
      "00-XX": "Généralités",
  ...
  problems: {
    ...
    hintsCount: (count: number) => `${count} indication${count > 1 ? "s" : ""}`,
    spoiler: "Spoiler :",
    previous: "Précédent",
    next: "Suivant",
  ...
  concepts: {
    paginationLabel: "Pagination des concepts",
    previousPage: "Page précédente",
    nextPage: "Page suivante",
    pageStatus: (page: number, total: number) => `Page ${page} sur ${total}`,
    resultsRange: (from: number, to: number, total: number) => total === 0 ? "Aucun concept trouvé" : `${from}–${to} sur ${total} concept${total > 1 ? "s" : ""}`,
    title: "Concepts",
  ...
  markdownEditor: {
    ...
    localDraftConflict: "La page a changé. Votre brouillon est conservé dans ce navigateur ; la dernière version du site est affichée. Vous pouvez restaurer votre brouillon pour reprendre vos corrections.",
    discardLocalDraft: "Supprimer le brouillon local",
    discardDraft: "Supprimer le brouillon",
    addLink: "Ajouter un lien",
    linkTypeAriaLabel: "Type de lien",
    linkTypeAll: "Tous les types",
    linkTypeMathematician: "Mathématicien",
    linkTypeHistory: "Repère historique",
    linkTypeReference: "Référence",
    linkSearch: "Rechercher une page",
    linkSearchPlaceholder: "Titre, nom ou mot-clé",
    linkSearchHelp: "Choisissez une destination dans les résultats. Le texte sélectionné est conservé. Pour les concepts, les liens utilisent [[cible|texte visible]] : lors d’une traduction, gardez la cible et traduisez seulement le texte visible.",
    linkSearchMinimum: "Saisissez au moins deux caractères.",
    linkSearching: "Recherche…",
    linkSearchError: "La recherche a échoué. Modifiez votre recherche pour réessayer.",
  ...
  contentEditor: {
    ...
    conceptProposalConflict: "Ce concept a changé pendant votre modification. Votre proposition n’a pas été envoyée. La dernière version est affichée ; si votre navigateur a pu enregistrer le brouillon local, vous pouvez le restaurer dans l’éditeur ci-dessous et comparer les deux versions avant de renvoyer votre proposition.",
  ...
  historyPage: {
    ...
    difficultyUnset: "non définie",
    difficultyExplanation: "Difficulté enregistrée lors de cette révision. Les ajustements automatiques liés aux votes ne sont pas retracés ici.",
