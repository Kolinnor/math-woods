...
export default async function ProfilePage({
  ...
  const [problems, playlists, revisions, solved, favorites, solvedCount, currentUserSolved] = await Promise.all([
      ...
      <article>
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="muted mt-1">{user.role.toLowerCase()} · reputation {user.reputation}</p>
          </div>
          {isSelf && (
