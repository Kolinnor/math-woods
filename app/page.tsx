    ...
    <div className="home-page grid gap-10">
      <section className="home-hero">
        <div className="home-hero-copy">
          <p className="eyebrow">Problems, notes, paths</p>
          <h1>{tagline}</h1>
      ...
      <section className="daily-tip">
        <p className="daily-tip-label">Tip of the day</p>
        <h2>{tip.title}</h2>
        <p>{tip.body}</p>
      </section>
          ...
          {featured ? (
            ...
            >
              ...
              <p className="meta mt-3">
                difficulty {featured.difficulty ?? "unset"}/100 · {featured._count.attempts} attempts ·{" "}
                {featured._count.favorites} favorites
              </p>
            </Link>
          ) : (
          ...
          {problems.slice(1).map((problem) => (
            ...
            >
              ...
              <p className="meta mt-1">
                {domainLabel(problem.domain)} · @{problem.author.username}
              </p>
            </Link>
          ))}
        </div>
