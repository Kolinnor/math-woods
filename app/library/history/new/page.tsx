...
export default async function NewHistoryMilestonePage() {
  ...
  return <ForestPageLayout title={locale === "fr" ? "Proposer un repère historique" : "Suggest a historical milestone"} heroImage="/art/brook-in-the-forest.jpg"><HistoryMilestoneForm action={saveHistoryMilestoneFormAction.bind(null, null)} locale={locale} options={options} /></ForestPageLayout>;
}
