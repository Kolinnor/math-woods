...
assert.equal(mathWoodsTourCopy.fr.steps.length, 16);
assert.equal(mathWoodsTourCopy.en.steps.length, 16);
assert.equal(parseMathWoodsTourStep("-3", 16), 0);
assert.equal(parseMathWoodsTourStep("99", 16), 15);
