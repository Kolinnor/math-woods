...
window.mount=(locale,contentType)=>root.render(React.createElement('form',{key:++sequence,onSubmit:e=>{e.preventDefault();window.submissions++;}},React.createElement(ProblemCitationEditor,{initial:[],draftKey:'mw-citations:test',locale,contentType}),React.createElement('button',{type:'submit'},'Submit')));window.submissions=0;`);
